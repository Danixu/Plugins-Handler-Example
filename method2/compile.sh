...
g++ -fPIC -shared -g -I../common/include -Iinclude src/plugin1.cpp -o build/bin/plugins/plugin1.so
# Main program
echo "Main program"
g++ -I../common/include -g -Iinclude src/plugin_handler.cpp src/test_executable.cpp -ldl -std=c++17 -o build/bin/test_executable
